package pl.myaspera.bans.object;

import org.bukkit.configuration.ConfigurationSection;
import pl.myaspera.bans.BansPlugin;
import pl.myaspera.bans.util.TimeUtil;
...
public final class Mute {
    ...
    public String replaceMute() {
        if(this.isPerm()) {
            String permBan = BansPlugin.getPlugin().getMessagesConfiguration().permMute;
        ...
        String tempBan = BansPlugin.getPlugin().getMessagesConfiguration().tempMute;
